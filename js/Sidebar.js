...
Sidebar.prototype.init = function()
{
    ...
    // 	 'Worker1', 'Soldier1', 'Doctor1', 'Tech1', 'Security1', 'Telesales1','ssss1','ssss2'], null,
    // 	 {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
    // 	  'Router_Icon': 'router switch'});

    // this.addImagePalette('clipart', mxResources.get('clipart'), dir + '/clipart/', '_128x128.png',
    //     ['Server01','Server02','Cabinet01','Cabinet02','PowerCabinet','Switch01','Switch02','Switch03',
    // 	'Routing_Switch01','Routing_Switch02','Routing_Switch03','Routing_Switch04',
    // 	'Optical_Fiber_Routing_Switch01','Optical_Fiber_Routing_Switch02',
    // 	'Two_Layer_Switch01','Two_Layer_Switch02','Stack_Switch01','Stack_Switch02',
    // 	'Middle_Routing_Switch01','Middle_Routing_Switch02','High_Routing_Switch',
    // 	'Route01','Route02','Route03','Route04','Route05','Route06','Route07','High_Route',
    // 	'Network_Abstract01','Network_Abstract02','Network_Abstract03','Network_Abstract04',
    // 	'CrossWall01','CrossWall02','Door01','Door02','Door03','Door04',
    // 	'Window01','Window02','Window03','window04'], null,
    //     {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
    //         'Router_Icon': 'router switch'});
 ...
 * }
 */
Sidebar.prototype.addGeneralPalette = function(modelData, id, expand)
{
    var fns = [];
    ...
    this.addPaletteFunctions(id, mxResources.get(id), (expand != null) ? expand : true, fns);
};
