...
/**
 * Adds the Attribute panel to the FormatPanel
 */
BaseFormatPanel.prototype.createAttributePanel = function()
{
    var div = document.createElement('div');
...
ArrangePanel.prototype.addGroupOps = function(div)
{
    ...
    if (graph.getSelectionCount() == 1)
    {
        ...
        mxUtils.br(div);
        btn = mxUtils.button('编辑属性', mxUtils.bind(this, function(evt)
        {
            ...
            if(attriDiv){
                ...
                attriDiv = this.createAttributePanel();
                this.format.container.appendChild(attriDiv);
                this.format.panels.push(new AttriPanel(this.format, ui, attriDiv));
            }
        }));
        btn.setAttribute('title', '编辑属性');
        btn.style.width = '202px';
        btn.style.marginBottom = '2px';
        div.appendChild(btn);
        count++;
 ...
 * Attribute Panel
 */
AttriPanel = function(format, editorUi, container)
{
    BaseFormatPanel.call(this, format, editorUi, container);
    this.init();
};
